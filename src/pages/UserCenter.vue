<template>
  <div class="page-container">
    <div class="page home-page" flex="dir:top box:first">
      <nav-bar title="个人中心" :goBack="goBack.bind(this)" />
...
export default {
  ...
  activated: function() {
    ...
    this.manmodelName = Tool.localItem("manmodelName")
      ? Tool.localItem("manmodelName")
      : "车辆管理";
    this.manmodelBack = Tool.localItem("manmodelBack")
      ? JSON.parse(Tool.localItem("manmodelBack"))
      : "";

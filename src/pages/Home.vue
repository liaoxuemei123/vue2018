      ...
      <div class="page-content" flex="dir:top box:justify">
        <div class="tbbar" flex="dir:left cross:center">
          <div class="bisiness-list">
            <xscroller>
              <div class="bisiness-item x-item" v-tap="changeActive.bind(this,index)" :class="{'active':activeBusiness == index}" v-for="(item,index) in bisinessItems" :key="index" flex="dir:left cross:center main:center">
            ...
            <div class="banner">
              <swiper>
                <div class="swiper-slide" flex="dir:left cross:center main:left">
                  <a href="http://mp.weixin.qq.com/s/GRSRXtl4w9T4Ky13uelWtQ">你的油耗总比别人高，问题出在这儿！</a>
                </div>
                <div class="swiper-slide" flex="dir:left cross:center main:left">
                  <a href="http://mp.weixin.qq.com/s/GRSRXtl4w9T4Ky13uelWtQ">你的油耗总比别人高，问题出在这儿！</a>
                </div>
                <div class="swiper-slide" flex="dir:left cross:center main:left">
                  <a href="http://mp.weixin.qq.com/s/okvpE8rTOLhfLwIO-rNMmw">学会这几招，雨天行车心不慌！</a>
                </div>
              </swiper>
            </div>
...
export default {
  ...
  created: function() {
    ...
    if ($.isEmptyObject(this.modelInfo)) {
      ...
      if (
        (this.$route.query.wbyQd == "oushang" && this.manmodel.typeName == "长安汽车") ||
        (this.$route.query.wbyQd == "QJJFCJ" && this.manmodel.typeName != "长安汽车")
      ) {
        return;
      }
      if (this.manmodel.id) {
  ...
  activated: function() {
    if (Tool.localItem("isUserCenterBack")) {
      ...
      if (this.bisinessItems.length == 1) {
        if (this.manmodel.id) {
          if (
            (this.bisinessItems[0].view == "CommercialSet" &&
              this.manmodel.typeName == "长安汽车") ||
            (this.bisinessItems[0].view == "MinniSet" && this.manmodel.typeName != "长安汽车")
          ) {

...
<template>
  <div class="page-container">
    <div class="store-page page" flex="dir:top box:first">
      <search placeholder="搜索4S店" :search="search.bind(this)" />
      <div class="page-content" flex="dir:top box:first">
        ...
        <div class="store-list-container">
          ...
          <div class="button-control">
            <btn-com title="确定" background="#00bffe" :onClick="submitStore" />
          </div>
...
export default {
  ...
  activated: function() {
    ...
    var height =
      Number($container.css("height").replace("px", "")) -
      Number($button.css("height").replace("px", ""));
    ...
    new Promise((res, rej) => {
      ...
      this.defaultLocation =
        this.geolocation.address.province + " " + this.geolocation.address.city;
    })
      .then(() => {
  ...
  computed: {
    ...mapState({
      ...
      storeInfo: ({ subscribe }) => subscribe.storeInfo
    })
  }
};
</script>

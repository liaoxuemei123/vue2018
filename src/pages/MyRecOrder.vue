<template>
  <div class="page-container">
    <div class="page rec-page" flex="dir:top box:first">
      <nav-bar title="我的推荐订单" />
      <div class="page-content" flex="dir:top box:last">
        <div class="rec-content" style="height:100%;">
          <div class="rec-price">
            <mt-datetime-picker ref="datepicker" type="date" v-model="pickerV" @confirm="onDateConfirm" month-format="{value}月" date-format="{value}日" :startDate="startDate" :endDate="endDate">
            </mt-datetime-picker>

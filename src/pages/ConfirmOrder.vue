        ...
        <div class="set-info">
          ...
          <div class="bottom" flex="dir:left box:mean">
            <div class="bottom-item" flex="dir:left cross:center main:left">
              <div class="title">
                <i class="iconfont icon-car"></i>车型:</div>
            ...
            <div class="bottom-item" flex="dir:left cross:center main:left" v-if="gmJudge('motorId')">
              <div class="title">
                <i class="iconfont icon-motor"></i>发动机号:</div>
          ...
          <div class="bottom" flex="dir:left box:mean">
            <div class="bottom-item" flex="dir:left cross:center main:left" v-if="gmJudge('vin')">
              <div class="title">
                <i class="iconfont icon-vin custom"></i>限用车架号:</div>
...
export default {
  ...
  computed: {
    ...mapState({
      userInfo: ({ packageinfo }) => packageinfo.userInfo,
      modelInfo: ({ packageinfo }) => packageinfo.modelInfo,
      setInfo: ({ packageinfo }) => packageinfo.setInfo,
      setDetail: ({ packageinfo }) => packageinfo.setDetail,
      ...
      protocolSure: ({ packageinfo }) => packageinfo.protocolSure
    })
  },
  components: {
    NavBar,
  ...
  methods: {
    ...
    goPay: function() {
      ...
      if (
        ...
        Tool.localItem("wbyQd") == "JJRFX" &&
        Tool.localItem("agentLogo")
      ) {
      ...
      Tool.post(
        "AaPackageOrder",
        {
          ...
          referee: this.userInfo.referee
            ? this.userInfo.refereeId == "111111" ? "" : this.userInfo.referee
            : "",
          refereeId: this.userInfo.refereeId
            ? this.userInfo.refereeId == "111111" ? "" : this.userInfo.refereeId
            : "",

<template>
  <div class="page-container">
    <div class="store-page page" flex="dir:top box:first">
      <self-search placeholder="搜索服务门店" :search="search.bind(this)" />
...
export default {
  ...
  methods: {
    ...
    getCityList: function(callback) {
      ...
      // var id = '471721b9-5c78-11e7-8995-3464a93301f7';
    ...
    try {
      ...
      geolocation.getCurrentPosition(position => {
        ...
        if (
          ...
          this.$route.name != "selectplate" &&
          position.address.city
        ) {
          Tool.post(
            "citycount",
            { city: position.address.city, province: position.address.province },
            data => {}
          );
        }
      });

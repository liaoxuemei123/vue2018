<template>
  <div class="page-container">
    <div class="page evaluate-page" flex="dir:top box:first">
      <nav-bar title='用户点评' rightContent='发表' :otherClass='true' :onRight="publicEvaluate" />
              ...
              <div class="single-item" flex="dir:left cross:center">
                ...
                <div class="score-evaluate" flex="dir:left cross:center">
                  <div class="score-evaluate-item" v-for="i in [1,2,3,4,5]" :key="i" @click="serverAttitude = i">
                    ...
                    <div class="iconfont icon-smile unhappy" v-else></div>
                  </div>
                </div>
        ...
        <div class="description" flex="dir:top box:first">
          ...
          <div class="content" flex="dir:top box:justify">
            ...
            <div class="evaluate-description">
              <textarea rows='5 ' placeholder="请描述一下你在服务门店的服务经历帮助一下其他小伙伴        写够15字才是好同志" v-model="explain">
              </textarea>
            </div>
    ...
    specialityLevel: function(val) {
      this.totalEvaluate = (
        (this.specialityLevel +
          this.facilityEvaluate +
          this.serverAttitude +
          this.softwareOperate) /
        4
      ).toFixed(1);
    },

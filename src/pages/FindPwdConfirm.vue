        ...
        <div class="pwd-box">
          <div class="login_box_row tel-input" flex="dir:left box:first cross:center">
            ...
            <div flex="dir:left box:last cross:center">
              ...
              <div class="close-container" v-show="closeContainerShow1" @click="clearInput">
          ...
          <div class="login_box_row picCodeRow" flex="dir:left box:first cross:center">
            ...
            <div flex="dir:left box:last cross:center">
              ...
              <div class="close-container" v-show="closeContainerShow2" @click="clearInput">
                <i class="iconfont  icon-close"></i>
              </div>
            </div>
          </div>
        </div>
        <div class='passText' v-show="passTextDisplay">
          <span class='tiSi'>请输入8-16位字母+数字或符号的组合</span>
        </div>
        <div class="button-control  active" id="login_login">
          <btn-com class="ableC" title="下一步" :onClick="onVerifyPwd" :class="btnAble?'ableC':'disableC'" />
        </div>
      </div>
      ...
      Tool.post(
        ...
        data => {
          if (data.result == 0) {
            ...
            var txtKey = RSAUtils.encryptedString(
              publicKey,
              encodeURIComponent(me.dataForget.password)
            );

...
<template>
  <div class="sub-page" key="subscribe" flex="dir:top box:last">
    <div class="page-content">
      <mt-datetime-picker ref="datepicker" type="datetime" v-model="pickerValue" @confirm="onDateConfirm" month-format="{value}月" date-format="{value}日" hour-format="{value}时" minute-format="{value}分" :startHour='startHour' :endHour='endHour' :startDate="startDate" :endDate="endDate">
      </mt-datetime-picker>
